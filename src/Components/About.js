...
function About() {
  return (
    <AboutContainerStyles id="about">
      ...
      Hello! My name is Agustin, I'm an Argentinean/Spanish industrial engineer. After graduating I decided to
      go deeper into the world of programming, so I studied in Argentinean universities and on my own through
      www.theodinproject.com languages related to web development. <br />
      These last months I started to do a master in project management, while I continue with my programming
      studies.
      <div>
        <br />
