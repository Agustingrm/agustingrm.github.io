...
function About() {
  return (
    <section id="about" className="aboutContainer">
      ...
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel turpis fringilla nulla semper vehicula. Sed at elit eros.
      Proin tempor ligula risus, ac tempor nunc eleifend eget. Sed lobortis diam at neque tristique, at rhoncus lacus lobortis.
      Sed a consectetur dui. Donec eu condimentum sem. Praesent ipsum ante, faucibus sit amet convallis at, pharetra non tellus.
      In quis est vitae turpis gravida placerat vel vitae nulla.
      <div>
